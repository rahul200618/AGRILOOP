...
import { generateFarmPlan } from '../services/geminiService';
import { FarmPlanResult } from '../types';
import { Calculator, Ruler, Sprout, IndianRupee, Droplets, ClipboardList, MapPin } from 'lucide-react';

export const AgriculturalPlanner: React.FC = () => {
